...
This repository contains a terminal-style portfolio webpage. Below is the code for the HTML, CSS, and JavaScript used in this project.
...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="https://AshishYesale.eu.org/images/favicon.png" />
